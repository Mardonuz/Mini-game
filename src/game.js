...
export class Game {
  ...
  draw(ctx) {
    ...
    this.sprites.drawTower(ctx, this.player.king, "#4f7be0", "king");
    this.sprites.drawTower(ctx, this.enemy.topTower, "#e04f7b");
    this.sprites.drawTower(ctx, this.enemy.bottomTower, "#e04f7b");
    this.sprites.drawTower(ctx, this.enemy.king, "#e04f7b", "king");
    ...
    for (const ef of this.effects) this.sprites.drawEffect(ctx, ef);
