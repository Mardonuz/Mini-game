...
export class AIController {
  ...
  pickLane(game) {
    ...
    // Critical tower focus: if a tower is almost dead, finish it
    if (pTopHp > 0 && pTopHp < 250 && elixir >= 4) return "top";
    if (pBotHp > 0 && pBotHp < 250 && elixir >= 4) return "bottom";
    ...
    // If king is active and side towers are down, focus center
    if (game.player.topTower.hp <= 0 && game.player.bottomTower.hp <= 0) {
